...
import static com.etiqa.assessment.config.Constants.Global.UID_HEADER_NAME;
...
public final class Constants {
    ...
    public static final class ErrorMessages {
        public static final String UID_NOT_FOUND = UID_HEADER_NAME + " not found";
        public static final String JSON_UTIL_ERROR_EMPTY_INPUT = "Empty input";
        private ErrorMessages() { throw new IllegalStateException(UTILITY_CLASS); }
    }
}
