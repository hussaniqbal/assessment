...
import com.etiqa.assessment.config.Constants;
import jakarta.persistence.*;

import java.io.Serializable;
import java.util.Date;

import static com.etiqa.assessment.config.Constants.BaseEntityConstants.*;
...
public abstract class BaseEntity implements Serializable {
    ...
    public String toString() {
        return "BaseEntity{" + CREATED_TS + "=" + insertTs + ", " + MODIFIED_TS + "="
                ...
                + '\'' + ", " + Constants.BaseEntityConstants.CREATED_BY + "='" + createdBy + '\'' + '}';
    }
}
